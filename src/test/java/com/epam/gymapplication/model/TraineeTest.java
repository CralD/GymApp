...
class TraineeTest {
    ...
    @BeforeEach
    public void setUp() {
        trainee = new Trainee("Ana", "Arteaga", "123456789a", "Anar", 1L, true, LocalDate.of(1990, 1, 1), "calle 30 carrera 50");
    }
    ...
    public void testCreateTrainee(){
        ...
        assertEquals(1L, trainee.getId(), "ID should match");
    ...
    public void testCreateTwoTrainees() {
        ...
        Trainee trainee2 = new Trainee("pedro", "juan", "b455q99", "peju", 2L, false, LocalDate.of(1975, 6, 22), "carrera 22 calle 22");
